...
for epoch in range(cmd_args.num_epochs):
    ...
    with open(args.data_name+'manij_loss_results.txt', 'a+') as f:
        f.write(str(avg_loss[0]) + '\n')
    with open(args.data_name+'manij_acc_results.txt', 'a+') as f:
        f.write(str(avg_loss[1]) + '\n')
    with open(args.data_name+'manij_auc_results.txt', 'a+') as f:
        f.write(str(avg_loss[2]) + '\n')
    with open(args.data_name+'manij_ap_results.txt', 'a+') as f:
